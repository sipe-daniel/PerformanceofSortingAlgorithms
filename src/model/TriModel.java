...
public class TriModel {
     ...
     * @param array
    */
    public void triSelection(int indice,List<Integer> tabPlage,ArrayList<ArrayList<Integer>> array){
        int i,j;
        int indMin, min, tmp;
        int plage = tabPlage.get(indice);
    ...
    */
    ...
    public void triInsertion(int indice,List<Integer> tabPlage,ArrayList<ArrayList<Integer>> array){
        int i, j;
        int plage =  tabPlage.get(indice);
        int elementInsere;
    ...
    */
      ...
      public void triBulle(int indice,List<Integer> tabPlage,ArrayList<ArrayList<Integer>> array){
        int  j = tabPlage.get(indice)  , tmp,s,v;
    ...
    public void coreTriFusion(int indice,List<Integer> tabPlage, ArrayList<ArrayList<Integer>> array){
        int plage = tabPlage.get(indice);
